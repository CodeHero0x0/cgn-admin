		...
		<div>
			...
			>
				<el-tab-pane label="基本信息">
					 <el-form ref="basicDataFormRef"  label-width="120px"  :rules="basicDataFormRules" :model="basicDataForm">
				...
				<el-tab-pane label="API SQL 配置">
					 <el-form ref="apiSqlFormRef"  label-width="120px"  :rules="apiSqlFormRules" :model="apiSqlForm">
						...
						<el-form-item label="sql分隔符" prop="sqlSeparator" >
							<el-tooltip
									class="box-item"
									effect="dark"
						...
						<el-form-item label="查询最大行数"  prop="sqlMaxRow">
							<el-tooltip
									effect="dark"
