<template>
  <el-drawer v-model="visible" title="详情" size="100%" :destroy-on-close="false">
    <div>
      <el-tabs
          tab-position="top"
      >
...
import {useApiConfigApi, getIpPortApi, getAuthInfoApi} from '@/api/data-service/apiConfig'
import ReadOnlyStudio from '@/components/console-result/readonly-studio.vue'
